        ...
        <div className="surface grid overflow-hidden rounded-2xl lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
          <div className="p-8 sm:p-12">
            ...
            <p className="mt-5 max-w-[30rem] text-[16px] leading-[1.55] text-ink-soft">
              Orbio pays for it, Robinhood Chain remembers it, and it acts through the accounts you already have. GitHub and X connect in a click; anything that speaks for you waits for your approval the first time.
            </p>
          </div>
