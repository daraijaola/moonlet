...
const SPRITES = ["moonlet", "github", "discord", "orbio", "openrouter", "robinhood"] as const;
...
export function ToolPhysics({ className }: { className?: string }) {
  ...
  return (
    <div
      ref={host}
      aria-label="Tiles for moonlet, GitHub, Discord, Orbio, OpenRouter and Robinhood Chain"
      role="img"
